  ...
  template: `
    <ng-template #portalRef>
      <div
        ...
        class="dark:bg-gray-700 bg-gray-50 rounded-lg fixed z-10 shadow-2xl max-h-[260px] overflow-y-auto inner-scrollbar scroll-smooth"
        [ngStyle]="posStyle"
        @openClose
      >
        <input
          ...
          type="text"
          class="w-full py-2 px-1 common-input text-sm input-focus input-colors capitalize rounded-lg mt-1"
